...
// Добавляем класс DataManager, который  будет работать либо с файлами, либо с базой данных
// Это позволяет разделить ответственности (есть Дневник, а есть ответственность сохранения данных)
class DataManager {
